...
public class Lab_3 extends JFrame {
    ...
    public Lab_3(Double[] coefficients) {
        ...
        saveToTextMenuItem.setEnabled(false);// Создать новое "действие" по сохранению в текстовый файл
        ...
        Action searchValueAction = new AbstractAction("Найти значение многочлена") {
            public void actionPerformed(ActionEvent event) {
                ...
                String value = JOptionPane.showInputDialog(Lab_3.this,
        ...
        buttonCalc.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ev) {
                try {
                    ...
                    data = new GornerTableModel(from, to, step, Lab_3.this.coefficients);
                    ...
                    JOptionPane.showMessageDialog(Lab_3.this, "Ошибка в формате записи числа с плавающей точкой", "Ошибочный формат числа", JOptionPane.WARNING_MESSAGE);
                }
            }
        });
    ...
    protected void saveToGraphicsFile(File selectedFile) {
        ...
        public static void main(String[] args) {
            ...
            Lab_3 frame = new Lab_3(coefficients);
